        ...
        <div class="container-fluid my-4">
          ...
          <div class="row m-1">
            <div class="card p-3" style="border-radius: 25px">
              <div class="row mb-3">
                <div class="col-6">
                  <div class="h5 font-weight-bold text-black">Keunggulan</div>
                </div>
  ...
  methods: {
    ...
    async sendUpdateData() {
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_API_ENDPOINT}/keunggulan/update/${
            this.dataUpdate.id
          }`,
          formData,
          {
    ...
    async tambahData() {
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_API_ENDPOINT}/keunggulan/create`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    async fetchData() {
      ...
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_ENDPOINT}/keunggulan/list`,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
    ...
    async deleteData(id) {
      try {
        const response = await axios.delete(
          `${import.meta.env.VITE_API_ENDPOINT}/keunggulan/delete/${id}`,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
